...
if __name__ == '__main__':
    eg = ExperimentGrid(exp_name='CPO-Safety-Benchmark')
    ...
    # 3. Constraint Configs (CPO enforces this strictly via projection)
    eg.add('algo_cfgs:cost_limit', [25.0])
    ...
    print("Launching CPO Grid (Strict Trust-Region Constraint)...")
