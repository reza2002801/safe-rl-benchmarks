...
if __name__ == '__main__':
    eg = ExperimentGrid(exp_name='PPOLag-Safety-Benchmark')
    ...
    # 3. Lagrange Configs (Crucial for enforcing safety limit d=25)
    eg.add('lagrange_cfgs:cost_limit', [25.0])
    ...
    print("Launching PPO-Lagrangian Grid (Adaptive Constraint)...")
